...
In order to implement multiple imputation in Stata, we can follow the guide called [Multiple imputation in Stata](https://stats.oarc.ucla.edu/stata/seminars/mi_in_stata_pt1_new/), developed by UCLA. 
